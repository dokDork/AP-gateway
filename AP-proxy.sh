...
function show_usage {
    ...
    echo "                     The ports to be redirected must be in the following form: \"destination port->local port to be redirected to,destination port->local port to be redirected to\""
